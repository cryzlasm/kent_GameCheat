...
class Cdm_basis : public COleDispatchDriver
{
public:
	Cdm_basis(){} // Calls COleDispatchDriver default constructor
	Cdm_basis(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	Cdm_basis(const Cdm_basis& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
