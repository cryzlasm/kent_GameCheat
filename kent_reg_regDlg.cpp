// kent_reg_regDlg.cpp : implementation file
//

#include "stdafx.h"


// kent_reg_regDlg dialog

IMPLEMENT_DYNAMIC(kent_reg_regDlg, CDialogEx)

kent_reg_regDlg::kent_reg_regDlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(kent_reg_regDlg::IDD, pParent)
{
...
void kent_reg_regDlg::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(kent_reg_regDlg, CDialogEx)
	ON_BN_CLICKED(IDC_BUTTON_REG, &kent_reg_regDlg::OnBnClickedButtonReg)
END_MESSAGE_MAP()


void kent_reg_regDlg::OnBnClickedButtonReg()
{
